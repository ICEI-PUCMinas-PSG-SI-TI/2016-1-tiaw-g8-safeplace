...
Link GitHub: https://github.com/ICEI-PUCMinas-PSG-SI-TI/2016-1-tiaw-g8-safeplace
...
1. Visual Studio Code: Principal ferramenta utilizada para gerar código HTML, CSS, JavaScript e ler arquivos .md
2. Miro: Indicação do professor
3. PowerPoint: Referência na criação de apresentações
4. GitHub: Comum para armazenamento e documentação de código; indicado pelo professor
